...
expected_metadata_json = '[{"name": "0 Day GFS GHI", "interval_value_type": "interval_mean", "interval_length": 60.0, "interval_label": "beginning", "normalization_factor": 1.0, "uncertainty": 1.0, "cost": {"name": "example cost", "type": "constant", "parameters": {"cost": 1.0, "aggregation": "sum", "net": true}}, "forecast": {"name": "0 Day GFS GHI", "issue_time_of_day": "07:00", "lead_time_to_start": 0.0, "interval_length": 60.0, "run_length": 1440.0, "interval_label": "beginning", "interval_value_type": "interval_mean", "variable": "ghi", "forecast_id": "da2bc386-8712-11e9-a1c7-0a580a8200ae", "provider": ""}, "reference_forecast": null, "observation": {"name": "University of Arizona OASIS ghi", "variable": "ghi", "interval_value_type": "interval_mean", "interval_length": 1.0, "interval_label": "ending", "uncertainty": 1.0, "observation_id": "9f657636-7e49-11e9-b77f-0a580a8003e9", "provider": ""}, "aggregate": null}, {"name": "Day Ahead GFS GHI", "interval_value_type": "interval_mean", "interval_length": 60.0, "interval_label": "beginning", "normalization_factor": 1000.0, "uncertainty": 15.0, "cost": {"name": "example cost", "type": "constant", "parameters": {"cost": 1.0, "aggregation": "sum", "net": true}}, "forecast": {"name": "Day Ahead GFS GHI", "issue_time_of_day": "07:00", "lead_time_to_start": 1440.0, "interval_length": 60.0, "run_length": 1440.0, "interval_label": "beginning", "interval_value_type": "interval_mean", "variable": "ghi", "forecast_id": "68a1c22c-87b5-11e9-bf88-0a580a8200ae", "provider": ""}, "reference_forecast": {"name": "0 Day GFS GHI", "issue_time_of_day": "07:00", "lead_time_to_start": 0.0, "interval_length": 60.0, "run_length": 1440.0, "interval_label": "beginning", "interval_value_type": "interval_mean", "variable": "ghi", "forecast_id": "refbc386-8712-11e9-a1c7-0a580a8200ae", "provider": ""}, "observation": {"name": "University of Arizona OASIS ghi", "variable": "ghi", "interval_value_type": "interval_mean", "interval_length": 1.0, "interval_label": "ending", "uncertainty": 1.0, "observation_id": "9f657636-7e49-11e9-b77f-0a580a8003e9", "provider": ""}, "aggregate": null}, {"name": "GHI Aggregate FX 60", "interval_value_type": "interval_mean", "interval_length": 60.0, "interval_label": "beginning", "normalization_factor": 1.0, "uncertainty": 5.0, "cost": {"name": "example cost", "type": "constant", "parameters": {"cost": 1.0, "aggregation": "sum", "net": true}}, "forecast": {"name": "GHI Aggregate FX 60", "issue_time_of_day": "00:00", "lead_time_to_start": 0.0, "interval_length": 60.0, "run_length": 1440.0, "interval_label": "beginning", "interval_value_type": "interval_mean", "variable": "ghi", "forecast_id": "49220780-76ae-4b11-bef1-7a75bdc784e3", "provider": ""}, "reference_forecast": null, "observation": null, "aggregate": {"name": "Test Aggregate ghi", "description": "ghi agg", "variable": "ghi", "aggregate_type": "mean", "interval_length": 60.0, "interval_label": "ending", "timezone": "America/Denver", "observations": [{"effective_from": "2019-01-01T00:00:00+00:00", "effective_until": "2020-01-01T00:00:00+00:00", "observation_deleted_at": null, "observation_id": "123e4567-e89b-12d3-a456-426655440000"}, {"effective_from": "2019-01-01T00:00:00+00:00", "effective_until": null, "observation_deleted_at": null, "observation_id": "e0da0dea-9482-4073-84de-f1b12c304d23"}, {"effective_from": "2019-01-01T00:00:00+00:00", "effective_until": null, "observation_deleted_at": null, "observation_id": "b1dfe2cb-9c8e-43cd-afcf-c5a6feaf81e2"}], "aggregate_id": "458ffc27-df0b-11e9-b622-62adb5fd6af0", "provider": "Organization 1", "interval_value_type": "interval_mean"}}]'  # NOQA
