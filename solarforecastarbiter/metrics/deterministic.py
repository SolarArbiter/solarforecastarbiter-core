...
def forecast_skill(y_true, y_pred, y_ref):
    ...
    -------
    s : float
        The forecast skill [-] between the true and predicted values.
...
def pearson_correlation_coeff(y_true, y_pred):
    ...
    -------
    r : float
        The correlation coefficient (r [-]) between the true and predicted values.
...
def coeff_determination(y_true, y_pred):
    ...
    -------
    r2 : float
        The coefficient of determination (R^2 [-]) between the true and predicted values.
