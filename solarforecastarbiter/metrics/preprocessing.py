...
def fill_static_value(values, quality_flags, default_value, threshold):
    """
    Return a timeseries with fillin of the questionable values
    (quality-flag = 1) with the given default value.
...
def fill_forward(values, quality_flags, threshold):
    """
    Return a timeseries with fillin of the questionable values
    (quality-flag = 1) with the given the last value.
...
def fill_by_interpolation(values, quality_flags, threshold):
    """
    Return a timeseries with fillin of the questionable values
    (quality-flag = 1) by interpolation as long as the number of consective
    values is less than the threshold, otherwise they will be excluded.
