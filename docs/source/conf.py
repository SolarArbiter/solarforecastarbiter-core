...
htmlhelp_basename = 'SolarForecastArbiterCoredoc'
...
latex_documents = [
    (master_doc, 'SolarForecastArbiterCore.tex', 'Solar Forecast Arbiter Core Documentation',
     'Solar Forecast Arbiter Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'solarforecastarbitercore', 'Solar Forecast Arbiter Core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SolarForecastArbiterCore', 'Solar Forecast Arbiter Core Documentation',
     author, 'SolarForecastArbiterCore', 'One line description of project.',
     'Miscellaneous'),
]
