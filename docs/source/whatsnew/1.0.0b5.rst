...
* Added a day of week persistence forecast method 
  :py:func:`solarforecastarbiter.reference_forecasts.persistence_dayofweek`
  which can be used as a baseline load forecast. (:issue:`55`) (:pull:`392`)
