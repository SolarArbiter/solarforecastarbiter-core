...
* Add probabilistic forecasts from NWP (GEFS) capability with two functions:
  ...
  (:issue:`54`)
* Add method to detect clear-sky periods using GHI data, for time intervals
  up to 15 minutes. (:issue:`19`)
    * :py:func:`~solarforecastarbiter.validation.validator.detect_clearsky_ghi`
